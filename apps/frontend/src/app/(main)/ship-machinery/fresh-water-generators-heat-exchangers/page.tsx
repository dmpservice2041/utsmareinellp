                                    ...
                                    <div className="mb-6">
                                        <div className="w-full h-64 bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl flex items-center justify-center overflow-hidden relative">
                                            ...
                                            >
                                                ...
                                                {/* Water Droplet/Generator Icon */}
                                                <g transform="translate(600, 337.5)">
                                                    <path d="M0 -60 Q 40 -20, 40 20 Q 40 60, 0 80 Q -40 60, -40 20 Q -40 -20, 0 -60 Z" fill="none" stroke="currentColor" strokeWidth="4" opacity="0.4" />
                                                    <circle cx="0" cy="10" r="30" fill="none" stroke="currentColor" strokeWidth="3" opacity="0.3" />
                                                    <path d="M-50 0 L-70 0 M50 0 L70 0" stroke="currentColor" strokeWidth="4" opacity="0.4" />
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
