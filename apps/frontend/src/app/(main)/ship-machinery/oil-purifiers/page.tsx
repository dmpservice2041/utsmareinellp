                                        ...
                                        <div className="w-full h-64 bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl flex items-center justify-center overflow-hidden relative">
                                            ...
                                            >
                                                ...
                                                <g transform="translate(600, 337.5)">
                                                    <path
                                                        d="M-100 -120 L100 -120 L20 0 L20 120 L-20 120 L-20 0 Z"
                                                        fill="none"
                                                        stroke="currentColor"
                                                        strokeWidth="4"
                                                        opacity="0.4"
                                                    />
                                                    <circle cx="0" cy="60" r="15" fill="currentColor" opacity="0.3" />
                                                    <circle cx="0" cy="-60" r="10" fill="currentColor" opacity="0.3" />
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
