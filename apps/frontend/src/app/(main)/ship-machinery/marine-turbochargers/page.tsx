                                        ...
                                        <div className="w-full h-64 bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl flex items-center justify-center overflow-hidden relative">
                                            ...
                                            >
                                                ...
                                                <g transform="translate(600, 337.5)">
                                                    <circle cx="0" cy="0" r="60" fill="none" stroke="currentColor" strokeWidth="3" opacity="0.4" />
                                                    <circle cx="0" cy="0" r="40" fill="none" stroke="currentColor" strokeWidth="3" opacity="0.3" />
                                                    <path d="M-60 0 L-100 -30 L-100 30 Z" fill="currentColor" opacity="0.3" />
                                                    <path d="M60 0 L100 -30 L100 30 Z" fill="currentColor" opacity="0.3" />
                                                    <circle cx="0" cy="0" r="20" fill="currentColor" opacity="0.4" />
                                                </g>
                                            </svg>
                                        </div>
                                    </div>
